...
To check the meaning of each variable, users can run the `data_dictionary()`, 
which will open the file with the dictionary of variables in each dataset. The dictionary file is either an `.html`, a `.pdf` or an `.xlsx` file, depending on 
the data set and year.
