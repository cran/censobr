...
which returns the path to the file with the dictionary of variables, and opens it
in an interactive session. The dictionary file is either a `.pdf` or an `.xlsx`
